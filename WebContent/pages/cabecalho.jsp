	...
	<tr>
		<td class="width40px center">
			<logic:present name="btpUsuario" property="usuTxtNome">
				<a href="javascript:void(0)" accesskey="m" data-name="btnNavmenu" class="fa fa-navicon fa-2x" style="padding: 0px 2px 0px 5px;" tabindex="-1"></a>
			</logic:present>
		</td>
		<td class="width40px center">
			<logic:present name="btpUsuario" property="usuTxtNome">
				<logic:present name="showNewButtom">
					<a href="javascript:void(0)" accesskey="n" class="fa fa-plus-square-o fa-2x" style="padding: 2px 2px 0px 5px;" tabindex="-1" onclick="movimentoFormPopup.show(null);"></a>
				</logic:present>
			</logic:present>
		</td>
		<td class="center">
